...
const foodImageKeywords = {
  ...
  '초리소':'chorizo,grilled',
  '로스트 치킨':'roast-chicken,golden', '버섯 크림 수프':'mushroom-soup,creamy',
  '염소 치즈':'goat-cheese,fresh', '연어구이':'grilled-salmon,seafood',
  '허브 구이':'herb-roast,meat', '생선구이':'grilled-fish,korean',
};
