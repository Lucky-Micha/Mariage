...
const foodPhotoIds = {
  ...
  '두부조림':   30200734,  '제육볶음': 12100417,  '두부김치': 8954474,
  // 서양·공통
  ...
  '회':           555775,   '참치회': 3298598,   '모듬회': 2323398,  '버터구이 새우': 28525132,
...
function recommend() {
  ...
  const fallbackItems = {
    soju:      { hot:['참치회','모듬회','오이소박이','문어숙회'],warm:['삼겹살','목살구이','닭발'], cool:['보쌈','족발','순대국'], cold:['전골','매운탕','감자탕','해장국'], rainy:['김치전','파전','도토리묵'], snowy:['굴전','대구탕','육개장'] },
