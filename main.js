...
// ── Food image search terms for Unsplash ─────────────────────────────────
// Images sourced from Unsplash (https://unsplash.com)
// Unsplash License: Free for commercial and personal use. Attribution not required.
// Full license: https://unsplash.com/license
const foodSearchTerms = {
  // 한식
  '오이소박이':'cucumber,kimchi,korean',
  '파전':'pajeon,korean,pancake,scallion',
  '문어숙회':'octopus,seafood,korean',
  '삼겹살':'pork belly,korean bbq,grill',
  '목살구이':'grilled pork,korean bbq',
  '닭발':'chicken feet,korean,spicy',
  '보쌈':'boiled pork,korean,cabbage wrap',
  '족발':'braised pork,korean,jokbal',
  '순대국':'korean soup,sausage,broth',
  '감자탕':'pork soup,potato,korean stew',
  '해장국':'korean soup,beef,hangover soup',
  '순대국밥':'korean soup,rice,broth',
  '김치전':'kimchi pancake,korean,crispy',
  '도토리묵':'acorn jelly,korean,side dish',
  '굴전':'oyster,pancake,korean',
  '대구탕':'cod fish,soup,korean',
  '육개장':'spicy beef soup,korean,stew',
  '어묵탕':'fish cake,soup,korean',
  '오이무침':'cucumber salad,korean,side dish',
  '미나리전':'herb pancake,korean,crispy',
  '열무김치':'radish kimchi,korean,banchan',
  '빈대떡':'mung bean pancake,korean,bindaetteok',
  '해물파전':'seafood pancake,korean,haemul pajeon',
  '도토리묵무침':'acorn jelly salad,korean',
  '장떡':'korean pancake,miso,crispy',
  '감자전':'potato pancake,korean,crispy',
  '수육':'boiled pork belly,korean,sliced',
  '편육':'sliced pork,korean,cold cuts',
  '닭볶음탕':'braised chicken,korean,spicy stew',
  '생굴':'fresh oysters,half shell,ice',
  '연포탕':'octopus soup,korean,broth',
  '배추전':'cabbage pancake,korean,pan fried',
  '고추전':'stuffed pepper,korean,pan fried',
  '굴보쌈':'oyster,pork,korean bossam',
  '두부조림':'braised tofu,korean,spicy',
  '묵무침':'jelly salad,korean,sesame',
  '두부김치':'tofu kimchi,korean,stir fry',
  '계란말이':'egg roll,korean,omelette',
  '김치찌개':'kimchi stew,korean,jjigae',
  '제육볶음':'spicy pork,korean,stir fry',
  '홍어무침':'skate ray,korean,fermented',
  '꼴뚜기볶음':'squid,korean,spicy stir fry',
  '새우젓 두부':'tofu,shrimp,korean',
  '미역냉국':'seaweed soup,korean,cold',
  '동태찌개':'pollack stew,korean,spicy',
  '돼지국밥':'pork rice soup,korean,milky broth',
  '회':'sashimi,raw fish,korean,sliced',
  '조개구이':'grilled clams,shellfish,butter',
  '야키토리':'yakitori,grilled chicken,skewer,japanese',
  '가라아게':'karaage,fried chicken,japanese,crispy',
  '교자':'gyoza,dumplings,pan fried,japanese',
  // 서양·공통 안주
  '치킨':'fried chicken,crispy,golden',
  '감자튀김':'french fries,golden,crispy',
  '나초':'nachos,cheese,chips,guacamole',
  '소시지구이':'grilled sausage,bratwurst,mustard',
  '팝콘':'popcorn,snack,bowl',
  '소시지':'sausage,grilled,herbs',
  '치즈버거':'cheeseburger,beef,bun,cheddar',
  '콘도그':'corn dog,stick,ketchup',
  '바베큐 립':'bbq ribs,pork,smoky,grill',
  '옥수수구이':'grilled corn,butter,cob',
  '피자':'pizza,margherita,mozzarella,italian',
  '어니언링':'onion rings,crispy,fried',
  '핫도그':'hot dog,bun,mustard',
  '새우튀김':'tempura shrimp,fried,golden',
  '치즈 플레이터':'cheese board,brie,grapes,crackers',
  '스테이크':'steak,grilled,beef,medium rare',
  '버섯볶음':'sauteed mushrooms,garlic,herbs',
  '핫윙':'buffalo wings,chicken,hot sauce',
  '감자퓨레':'mashed potato,creamy,butter',
  '프레첼':'pretzel,soft,salt,mustard',
  '치즈스틱':'mozzarella sticks,fried,marinara',
  '트러플 팝콘':'truffle popcorn,gourmet,parmesan',
  '스모크 소시지':'smoked sausage,sliced,cutting board',
  '견과류':'mixed nuts,walnuts,almonds,bowl',
  '카프레제':'caprese salad,mozzarella,tomato,basil',
  '그린샐러드':'green salad,fresh,vinaigrette',
  '새우칵테일':'shrimp cocktail,ice,sauce',
  '쉬림프 칵테일':'shrimp cocktail,ice,sauce',
  '훈제연어':'smoked salmon,capers,cream cheese',
  '냉파스타':'cold pasta salad,vegetables,herbs',
  '바게트':'baguette,french bread,sliced,butter',
  '올리브':'olives,marinated,bowl,olive oil',
  '포도':'grapes,fresh,purple,vine',
  '리조또':'risotto,creamy,parmesan,italian',
  '버섯요리':'mushrooms,sauteed,gourmet,thyme',
  '치즈파스타':'pasta,cheese,creamy,fettuccine',
  '그라탕':'gratin,potato,baked,cheese crust',
  '양고기구이':'lamb chops,grilled,rosemary',
  '소꼬리찜':'oxtail,braised,dark sauce',
  '치즈퐁뒤':'cheese fondue,swiss,bread,dipping',
  '뮬드와인':'mulled wine,cinnamon,winter,spices',
  '브루스케타':'bruschetta,tomato,basil,toasted bread',
  '홍합찜':'steamed mussels,white wine,seafood',
  '오리 콩피':'duck confit,crispy skin,french',
  '뇨키':'gnocchi,potato,tomato sauce,basil',
  '트러플 리조또':'truffle risotto,parmesan,black truffle',
  '라클렛':'raclette,melted cheese,potatoes,swiss',
  '크루통 수프':'french onion soup,croutons,gruyere,gratinee',
  '빵과 버터':'sourdough bread,butter,artisan',
  '훈제 치즈':'smoked cheese,gouda,crackers,board',
  '살라미':'salami,charcuterie,sliced,cornichons',
  '다크 초콜릿':'dark chocolate,squares,cocoa',
  '체다 치즈':'cheddar cheese,wedge,crackers',
  '크래커':'crackers,assorted,artisan,snack',
  '블루치즈':'blue cheese,honey,walnuts,board',
  '호두':'walnuts,bowl,cracked,halves',
  '피클':'pickles,jar,dill,cucumber',
  '하몽':'jamon iberico,spanish ham,sliced,plate',
  '핫토디':'hot toddy,whiskey,lemon,honey,cinnamon',
  '삶은 달걀':'soft boiled egg,runny yolk,halved',
  '훈제 소시지':'smoked sausage,mustard,wooden board',
  '구운 감자':'baked potato,sour cream,chives',
  '치즈스프':'cheese soup,creamy,croutons,bowl',
  '블랙 올리브':'black olives,kalamata,bowl,olive oil',
  '파테':'pate,chicken liver,cornichons,baguette',
  '무화과잼':'fig jam,jar,fresh figs,toast',
  '캐러멜 팝콘':'caramel popcorn,candied,sweet,snack',
  '트러플 치즈':'truffle cheese,slate board,gourmet',
  '견과류 믹스':'mixed nuts,assorted,premium,bowl',
  '훈제 굴':'smoked oysters,half shell,lemon',
  '꿀':'honey,amber,dripping,wooden dipper',
  '과일 플레이터':'fruit platter,strawberries,grapes,melon',
  '아보카도 딥':'guacamole,tortilla chips,lime,avocado',
  '콜드 타파스':'tapas,spanish,cold platter,assorted',
  '카나페':'canapes,appetizers,party food,platter',
  '미니 브루스케타':'bruschetta,mini,tomato,basil,toast',
  '바질 카프레제':'caprese,basil,mozzarella,balsamic',
  '피타 칩':'pita chips,hummus,crispy,dip',
  '후무스':'hummus,olive oil,paprika,smooth',
  '올리브 핑거푸드':'antipasti,olive,finger food,platter',
  '미니 타코':'mini tacos,street food,salsa,cilantro',
  '스프링롤':'spring rolls,crispy,vietnamese,dipping sauce',
  '에다마메':'edamame,steamed,sea salt,green',
  '핫 바질 스프':'basil soup,creamy,hot,cream',
  '브리 치즈 구이':'baked brie,honey,walnuts,rosemary',
  '미트볼':'meatballs,tomato sauce,basil,italian',
  '브레드 볼 수프':'bread bowl,soup,creamy,warm',
  '피자 슬라이스':'pizza slice,cheese,pepperoni,melted',
  '치즈 딥 & 칩스':'cheese dip,tortilla chips,warm,snack',
  '쿠키':'cookies,fresh baked,assorted,sweet',
  '초콜릿':'chocolate,assorted,pieces,dark',
  '초콜릿 퐁뒤':'chocolate fondue,strawberries,marshmallows,dipping',
  '마시멜로':'marshmallows,toasted,golden,skewer',
  '크림 치즈 딥':'cream cheese dip,herbs,whipped,plate',
  '생강쿠키':'gingerbread cookies,decorated,holiday',
  // 드링크 전용 안주
  '꿀 리코타 크로스티니':'ricotta crostini,honey,walnuts,toast',
  '말린 무화과':'dried figs,wooden board,sweet',
  '말린 자두':'dried prunes,bowl,sweet,dried fruit',
  '살구 타르트':'apricot tart,pastry cream,french',
  '연어 타르타르':'salmon tartare,avocado,capers,fine dining',
  '카망베르 치즈':'camembert cheese,baked,crust,french',
  '사과 크럼블':'apple crumble,oat topping,ice cream,dessert',
  '구운 아몬드':'roasted almonds,rosemary,sea salt,bowl',
  '훈제 고등어':'mackerel fillet,smoked,fish,korean',
  '소금 크래커':'salted crackers,thin,plate,snack',
  '미소된장 수프':'miso soup,tofu,wakame,japanese bowl',
  '캐비어':'caviar,blini,creme fraiche,gourmet',
  '다크 초콜릿 트러플':'dark chocolate truffles,cocoa powder,gourmet',
  '파르미지아노':'parmesan cheese,aged,block,grater',
  '바베큐 폭립':'bbq spare ribs,smoky glaze,pork,grill',
  '맥앤치즈':'mac and cheese,baked,golden crust,comfort food',
  '체다버거':'smash burger,cheddar,caramelized onions',
  '피칸 파이':'pecan pie,slice,golden,dessert',
  '피칸':'pecans,whole,bowl,nuts',
  '구운 복숭아':'grilled peach,honey,thyme,dessert',
  '프루트 타르트':'fruit tart,pastry cream,berries,french',
  '훈제 체다치즈':'smoked cheddar,cheese board,wedge',
  '연어 니기리':'salmon nigiri,sushi,wooden board,japanese',
  '가리비 구이':'scallops,seared,butter,herbs,seafood',
  '화이트 초콜릿 트러플':'white chocolate truffles,coconut,sweet',
  '우메보시':'pickled plum,japanese,umeboshi,bowl',
  '고르곤졸라':'gorgonzola,blue cheese,crumbled,plate',
  '버터구이 가리비':'scallops,butter basted,seared golden,seafood',
  '유자 소르베':'citrus sorbet,yuzu,glass,dessert',
  '아이리시 스튜':'irish stew,lamb,root vegetables,hearty',
  '브라운 브레드':'irish brown bread,soda bread,rustic loaf',
  '뱅어즈앤매쉬':'bangers mash,sausages,gravy,british',
  '크림파스타':'creamy pasta,fettuccine,parmesan,italian',
  '버터구이 새우':'butter shrimp,garlic,herbs,seafood',
  '오리가슴살':'duck breast,pink,crispy skin,sliced',
  '포르치니 버섯':'porcini mushrooms,sauteed,butter,thyme',
  '토마토 파스타':'spaghetti,tomato sauce,basil,italian',
  '봉골레 파스타':'clam pasta,white wine,seafood,italian',
  '안티파스토':'antipasto,italian platter,cured meats,olives',
  '푸아그라':'foie gras,terrine,brioche,fig jam,gourmet',
  '이베리코 하몽':'iberico ham,thin slices,spanish,plate',
  '만체고 치즈':'manchego cheese,quince paste,spanish',
  '초리소':'chorizo,sliced,olives,spanish',
  '로스트 치킨':'roast chicken,golden,herbs,vegetables',
  '버섯 크림 수프':'mushroom soup,creamy,white bowl,cream swirl',
  '염소 치즈':'goat cheese,chevre,herbs,honey',
  '연어구이':'grilled salmon,lemon herb butter,fillet',
  '허브 구이':'herb crusted meat,rosemary,thyme,roasted',
  '생선구이':'grilled fish,whole,crispy skin,korean',
};
...
function foodImgUrl(name, attempt) {
  const terms = foodSearchTerms[name] || 'food,dish,appetizing';
  const seed = hashStr(name) + (attempt || 0);
  return `https://source.unsplash.com/400x533/?${encodeURIComponent(terms)}&sig=${seed}`;
}
...
function makeFoodCard(name) {
  ...
  img.addEventListener('error', () => {
    if (!retried) {
      retried = true;
      setTimeout(() => { img.src = foodImgUrl(name, 1); }, 1500);
    } else {
