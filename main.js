...
const drinkDatabase = [
  ...
  // ── 화이트 와인 ──────────────────────────────────────────────────────────
  {
    ...
    characteristics: '자몽·구스베리·패션프루트의 상큼한 과일 향과 풀·허브·피망의 신선한 식물성 향이 특징입니다. 높은 산도와 드라이한 스타일로, 뉴질랜드산은 열대과일의 강렬한 아로마가 폭발적이고, 프랑스 루아르산(상세르·푸이-퓌메)은 미네랄하고 세련된 풍미가 돋보입니다.',
    flavorTags: ['자몽', '구스베리', '허브', '패션프루트', '미네랄'],
    items: ['생굴', '그린샐러드', '훈제연어', '카프레제', '바게트'],
    pairingNote: '소비뇽 블랑의 높은 산도와 허브향은 신선한 해산물과 채소 요리의 생동감을 한껏 살려줍니다.',
  },
  {
    key: '리슬링',
    ...
    characteristics: '복숭아·살구·사과·라임의 선명한 과일 향에 꿀·석유·미네랄의 복합적인 뉘앙스가 어우러집니다. 높은 산도와 뚜렷한 미네랄리티 덕분에 달콤한 스타일도 전혀 무겁지 않으며, 수십 년의 장기 숙성이 가능합니다.',
    flavorTags: ['복숭아', '살구', '꿀', '미네랄', '라임'],
    items: ['오리가슴살', '목살구이', '블루치즈', '훈제 고등어', '사과 크럼블'],
    pairingNote: '리슬링의 높은 산도와 달콤한 과일 향은 향신료가 강한 요리와 지방이 풍부한 육류의 균형을 완벽하게 잡아줍니다.',
  },
  {
    key: '모스카토',
  ...
  // ── 레드 와인 (보르도/론 계열) ────────────────────────────────────────────
  {
    ...
    characteristics: '자두·블랙체리·초콜릿·바닐라의 부드럽고 풍성한 과일 향이 특징입니다. 카베르네 소비뇽보다 탄닌이 부드럽고 산도가 낮아 접근하기 쉬우며, 미디엄~풀바디로 벨벳처럼 매끄러운 질감이 매력입니다.',
    flavorTags: ['자두', '블랙체리', '초콜릿', '바닐라', '벨벳 탄닌'],
    items: ['스테이크', '오리 콩피', '버섯요리', '치즈파스타', '포르치니 버섯'],
    pairingNote: '메를로의 부드러운 탄닌과 풍성한 자두·초콜릿 향은 섬세한 육류와 크리미한 소스 요리와 탁월하게 어울립니다.',
  },
  {
    key: '시라',
    ...
    characteristics: '블랙베리·후추·훈제 고기·가죽·바이올렛의 강렬하고 복합적인 향이 특징입니다. 풀바디에 진한 색상, 강한 탄닌과 스파이시한 여운이 인상적이며, 호주 스타일은 과일 중심적이고 프랑스 스타일은 구조감이 뛰어납니다.',
    flavorTags: ['블랙베리', '후추', '훈제향', '가죽', '스파이시'],
    items: ['양고기구이', '바베큐 립', '스테이크', '훈제 소시지', '다크 초콜릿'],
    pairingNote: '시라의 스파이시한 후추 풍미와 풀바디는 훈제·구이 육류의 강렬한 맛을 완벽하게 받아줍니다.',
  },
  {
    key: '말벡',
    aliases: ['말벡', 'malbec'],
    ...
    characteristics: '블랙베리·자두·블루베리의 진한 과일 향에 초콜릿·바이올렛·담배의 복합적인 뉘앙스가 더해집니다. 탄닌이 부드럽고 풀바디로, 접근하기 쉽고 친근하면서도 구조감이 뛰어납니다.',
    flavorTags: ['블랙베리', '자두', '초콜릿', '바이올렛', '부드러운 탄닌'],
    items: ['스테이크', '양고기구이', '바베큐 립', '블루치즈', '다크 초콜릿'],
    pairingNote: '말벡의 부드러운 탄닌과 진한 과일 풍미는 그릴에 구운 붉은 육류와 이상적인 마리아주를 이룹니다.',
  },
  // ── 레드 와인 (이탈리아) ──────────────────────────────────────────────────
  {
    key: '산지오베제',
    ...
    characteristics: '체리·자두·토마토·허브·가죽의 복합적인 향이 어우러집니다. 높은 산도와 중간 수준의 탄닌, 드라이한 여운이 특징으로, 음식과 함께할 때 진가를 발휘하는 대표적인 푸드 와인입니다.',
    flavorTags: ['체리', '토마토', '허브', '가죽', '높은 산도'],
    items: ['토마토 파스타', '피자', '브루스케타', '하몽', '파르미지아노'],
    pairingNote: '산지오베제의 높은 산도와 허브 풍미는 토마토 소스 요리와 이탈리아 음식과 세계 최고의 궁합을 자랑합니다.',
  },
  {
    key: '네비올로',
    ...
    characteristics: '장미·타르·체리·트러플·가죽의 매우 복합적인 향이 특징입니다. 강한 탄닌과 높은 산도로 장기 숙성이 필수이며, 충분히 숙성된 바롤로는 세계에서 가장 복잡하고 우아한 레드 와인 중 하나로 꼽힙니다.',
    flavorTags: ['장미', '타르', '체리', '트러플', '강한 탄닌'],
    items: ['트러플 리조또', '스테이크', '포르치니 버섯', '양고기구이', '파르미지아노'],
    pairingNote: '네비올로의 복합적인 아로마와 강한 구조감은 트러플·포르치니 등 감칠맛 풍부한 식재료와 전설적인 마리아주를 이룹니다.',
  },
  // ── 레드 와인 (스페인) ────────────────────────────────────────────────────
  {
    key: '템프라니요',
    ...
    characteristics: '딸기·자두·담배·바닐라의 균형잡힌 과일 향이 특징입니다. 아메리칸 오크 숙성 시 코코넛·바닐라가 두드러지고, 프렌치 오크 숙성 시 가죽·흙향·시가의 복합적인 풍미가 발전합니다.',
    flavorTags: ['딸기', '자두', '담배', '바닐라', '가죽'],
    items: ['이베리코 하몽', '만체고 치즈', '양고기구이', '초리소', '올리브'],
    pairingNote: '템프라니요의 균형잡힌 탄닌과 바닐라 향은 이베리안 식재료와 양고기 요리와 완벽한 스페인 마리아주를 완성합니다.',
  },
];
...
const foodImageKeywords = {
  ...
  '토마토 파스타':'tomato-pasta,italian', '봉골레 파스타':'clam-pasta,seafood',
  '안티파스토':'antipasto,italian', '푸아그라':'foie-gras,french',
  '이베리코 하몽':'iberico-ham,spanish', '만체고 치즈':'manchego-cheese,spanish',
  '초리소':'chorizo,grilled',
};
